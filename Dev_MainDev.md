...
- BUG057用户口径更新：允许显式改用本地视频模型，不再以其他模型冒充H3；本轮只验2—3镜头、总时长≤15秒的视频，不验人声/BGM。Wan2.2 TI2V-5B在官方30步、704×1280复测仍于中段黑屏崩坏，改用已安装LTX-Video 2B Distilled进行同口径验收；65帧探针2.71秒逐帧稳定，现接入显式provider后走正式任务链。
