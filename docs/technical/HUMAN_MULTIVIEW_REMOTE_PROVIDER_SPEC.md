> **历史归档，禁止作为当前生产入口。** 本文的FLUX.1 Schnell正面近照、Visual Persona与PSHuman链已被M9.187覆盖。当前人物流程为Klein‑9B 0°正面全身基准人工确认后，Qwen‑Edit依次生成左45°、右45°、90°、180°和0°半身；人物TripoSR唯一输入为已确认0°正面全身。当前权威规范见`docs/specs/短剧从剧本到成片生产规范.md`与`docs/specs/短剧3D资产生产规范.md`。

# 人物全身与多视图远程 CUDA 服务契约（历史归档）
